...
<body class="container mt-5">
    ...
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <input type="date" name="donation_date" class="form-control" value="<?= htmlspecialchars($data['donation_date']) ?>" required>
        </div>
        <div class="mb-3">
            <label>Konum</label>
